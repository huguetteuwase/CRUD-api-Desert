 ...
 */
router.post("/reset-password/:resetToken", authController_1.resetPassword);
/**
 * @swagger
 * /api/auth/me:
 *   get:
 ...
 */
router.get("/users", auth_1.authenticate, (0, auth_1.authorize)(["admin"]), authController_1.getAllUsers);
/**
 * @swagger
 * /api/auth/users/{id}:
 *   get:
 ...
 *         description: Insufficient permissions
 */
router.get("/users/:id", auth_1.authenticate, (0, auth_1.authorize)(["admin"]), authController_1.getUserById);
/**
 * @swagger
 * /api/auth/users/{id}:
 *   put:
